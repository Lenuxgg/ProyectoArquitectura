...
public class ProcesarNominaDto
{
    ...
    [Range(0.0, 100.0, ErrorMessage = "El porcentaje de deducción debe estar entre 0 y 100.")]
    public decimal PorcentajeDeduccion { get; set; } = 10;

    [Range(0.0, 999999999999.99, ErrorMessage = "La bonificación no puede ser negativa.")]
